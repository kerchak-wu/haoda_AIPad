...
4. **UI 设计**：分辨率（默认 1920×1080）+ 配色（用户偏好浅色/多色文字/不用黑色/天空蓝背景）+ 布局 + 字体（从「字体文件/」目录选）+ 图标（从「icons/」目录选）+ 控件清单
...
### 资源目录
- `字体文件/` — 24 种中文字体（PingFang_Regular / msyh / simhei 等）
- `images/` — 背景图（1.jpg，1920×1080）
- `icons/` — 96 个 PNG 图标
